...
type PreviousCourse = {
    ...
    name: string;
    subtitle: string;
    // Ambil semua nama ikon yang valid langsung dari komponen Feather
    icon: React.ComponentProps<typeof Feather>['name'];
};

// --- DUMMY DATA DENGAN TIPE YANG BENAR ---
const categories: string[] = ["#Sunda", "#Javanese", "#Bali"];

const popularLanguages: PopularLanguage[] = [
    {id: '1', name: 'Sundanese'},
    {id: '2', name: 'Javanese'},
    {id: '3', name: 'Minangkabau'},
    {id: '4', name: 'Betawi'},
];
                        ...
                        <FlatList
                            ...
                            renderItem={({item}) => (
                                <TouchableOpacity className="mr-4 items-center">
                                    {/* GANTI Image DENGAN View SEBAGAI PLACEHOLDER */}
